...
* [`src/clj/coronavirus_charts/`](src/clj/coronavirus_charts/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/clj/coronavirus_charts/`](src/clj/coronavirus_charts/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/coronavirus_charts/`](src/cljs/coronavirus_charts/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/coronavirus_charts/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `coronavirus-charts` project root directory
...
in the [`src/clj/coronavirus_charts/`](src/clj/coronavirus_charts/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/coronavirus_charts/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns coronavirus-charts.example
  (:require [coronavirus-charts.config :as config])
...
standalone `coronavirus-charts.jar`.
...
```sh
port=2000 java -jar target/coronavirus-charts.jar
```
